const CACHE='gfp-online-v2-8';
const ASSETS=['./','./index.html','./config.js','./online.js?v=20260804-4','./manifest.webmanifest?v=20260804-1','./app-icon-192.png','./app-icon-512.png'];
