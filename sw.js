const CACHE='gfp-online-v2-6';
const ASSETS=['./','./index.html','./config.js','./online.js?v=20260804-2','./manifest.webmanifest?v=20260804-1','./app-icon-192.png','./app-icon-512.png'];
