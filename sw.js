const CACHE='gfp-online-v2-26';
const ASSETS=['./','./index.html','./config.js','./enhancements.css?v=20260804-12','./enhancements.js?v=20260804-12','./online.js?v=20260811-1','./manifest.webmanifest?v=20260810-2','./app-icon-192.png','./app-icon-512.png','./dib-staff-logo.png'];
